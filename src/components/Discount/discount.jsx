        ...
        <div className={s.discountSection}>
            ...
            <div className={s.containerGreen}>
                <div className={s.greenText}>
                    ...
                    <p>
                        The key to a successful renewal is to cut out the oldest stems about every third year. Simply cutting out the oldest, fattest stems of an overgrown shrub, allows for younger, thinner stems to remain in place to flower and fruit.
                        This will keep the growth in balance and maintain the best flowering and fruiting all while keeping the natural shape and size of the shrub!
                    </p>
                    <p>
                ...
                <div className={s.greenText}>
                    ...
                    <p>
                        Every plant from Vivero Henry™ comes protected by code testers providing you with plants free of invasive pests & diseases.
                        That means plants arrive safe & healthy at your doorstep.
                    </p>
                </div>
            </div>
        </div>
